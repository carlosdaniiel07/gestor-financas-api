...
import com.carlos.gestorfinancas.dtos.TransferenciaDTO;
...
public class TransferenciasResource {
	...
	@PostMapping
	public ResponseEntity<Transferencia> insere(@Valid @RequestBody TransferenciaDTO objDTO) {
		Transferencia obj = service.insere(objDTO.toTransferencia());
